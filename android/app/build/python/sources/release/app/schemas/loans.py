...
class LoanBase(BaseModel):
    loan_type: str = Field(..., regex="^(home|car|education|personal|business)$")
...
class DebtBase(BaseModel):
    ...
    debt_type: str = Field(..., regex="^(credit_card|personal_loan|borrowed|bank_loan|friend_loan)$")
    ...
    status: str = Field("active", regex="^(active|paid|overdue)$")
    notes: Optional[str] = None
...
class DebtUpdate(BaseModel):
    ...
    debt_type: Optional[str] = Field(None, regex="^(credit_card|personal_loan|borrowed|bank_loan|friend_loan)$")
    ...
    monthly_payment: Optional[float] = Field(None, ge=0)
    due_date: Optional[datetime] = None
    status: Optional[str] = Field(None, regex="^(active|paid|overdue)$")
    notes: Optional[str] = None
